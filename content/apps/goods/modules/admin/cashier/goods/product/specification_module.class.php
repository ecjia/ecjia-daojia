 ...
 * @author zrl
 */
class admin_cashier_goods_product_specification_module extends api_admin implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {	
    	...
    	if (!empty($specification)) {
    		if (!empty($specification)) {
    			...
    			$GoodsProductPrice->setGoodsSpecification($specification);
    	...
    	return ['specification' => $specification, 'product_specification' => $product_specification];
	}

	private function handle_spec($properties)
	{
