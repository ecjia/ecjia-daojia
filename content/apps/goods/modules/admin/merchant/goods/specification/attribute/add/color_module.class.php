 ...
 *
 */
class admin_merchant_goods_specification_attribute_add_color_module extends api_admin implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {
		...
		if ($attr_id) {
			...
			return new ecjia_error('add_attr_fail', __('添加颜色规格属性失败！', 'goods'));
		}
    }
}