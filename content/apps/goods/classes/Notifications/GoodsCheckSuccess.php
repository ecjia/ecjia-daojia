...
/**
 * 商品审核成功（商品审核通过发消息通知给商品所属店铺店长）
 */
class GoodsCheckSuccess extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct($goods_checksuccess_data)
    {
        //
        $this->notifiable_data = $goods_checksuccess_data;
    }
