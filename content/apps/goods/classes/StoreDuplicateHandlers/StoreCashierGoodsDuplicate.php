...
class StoreCashierGoodsDuplicate extends StoreDuplicateAbstract
{
    ...
    public function __construct($store_id, $source_store_id)
    {
        ...
        $this->source_store_data_handler = RC_DB::table('goods')->where('store_id', $this->source_store_id)->where('is_on_sale', 1)->where('is_delete', '!=', 1)->where('extension_code', 'cashier');
