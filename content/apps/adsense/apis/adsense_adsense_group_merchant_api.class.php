 ...
 * @author royalwang
 */
class adsense_adsense_group_merchant_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        ...
        RC_Hook::add_filter('filter_merchant_adsense_group_data', array($this, 'filter_merchant_adsense_group_data'), 9);
        
        $position = new Ecjia\App\Adsense\MerchantPositionManage('group');
