...
class MerchantAdGroupModel extends Model 
{
	protected $table = 'merchants_ad_position';
	...
	{
		return $this->hasMany('Ecjia\App\Adsense\Models\MerchantAdPositionModel', 'group_id', 'position_id');
	}
