                            ...
                            <div class="col-lg-8" style="padding-left:0px;">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">{t domain="adsense"}广告位名称：{/t}</label>
...
<!-- 									</div> -->
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">{t domain="adsense"}广告位代号：{/t}</label>
                                        <div class="controls col-lg-8">
											...
											{/if}
											<span class="help-block">{t domain="adsense"}广告位调用标识，且在同门店下该标识不可重复。{/t}<br>{t domain="adsense"}可随意填写，例如：“home_ad_1”  代表首页的第一个广告位{/t}</span>
                                        </div>
                                        <span class="input-must"><span class="require-field" style="color:#FF0000,">*</span></span>
                                    </div>
                                    
 									<div class="form-group">
				                        <label class="control-label col-lg-3">{t domain="adsense"}广告位描述：{/t}</label>
				                        <div class="controls col-lg-8 ">
			                      	...
			                      	<div class="form-group">
                                        ...
                                        <div class="controls col-lg-8">
                                            ...
                                            <span class="help-block">{t domain="adsense"}在此可设置前台调用该广告位的显示数量。{/t}</span>
                                        </div>
                                    </div>
