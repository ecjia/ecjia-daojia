                            ...
                            <div class="col-lg-8" style="padding-left:0px;">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">{t domain="adsense"}菜单组名称：{/t}</label>
...
<!-- 									</div> -->
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">{t domain="adsense"}菜单组代号：{/t}</label>
                                        <div class="controls col-lg-8">
											...
											{/if}
											<span class="help-block">{t domain="adsense"}菜单组调用标识，且在同门店下该标识不可重复。{/t}</span>
                                        </div>
                                        <span class="input-must"><span class="require-field" style="color:#FF0000,">*</span></span>
                                    </div>
                                    
 									<div class="form-group">
				                        <label class="control-label col-lg-3">{t domain="adsense"}菜单组描述：{/t}</label>
				                        <div class="controls col-lg-8 ">
			                      	...
			                      	<div class="form-group">
                                        ...
                                        <div class="controls col-lg-8">
                                            ...
                                            <span class="help-block">{t domain="adsense"}在此可设置前台调用该菜单组的菜单显示数量。{/t}</span>
                                        </div>
                                    </div>
