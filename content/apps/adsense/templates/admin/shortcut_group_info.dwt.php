			...
			<div class="row-fluid edit-page editpage-rightbar">
				<div class="left-bar move-mod">
			        <div class="control-group formSep">
			        	<label class="control-label">{t domain="adsense"}菜单组名称：{/t}</label>
			          	<div class="controls">
			        ...
			        <div class="control-group formSep">
			        	<label class="control-label">{t domain="adsense"}菜单组代号：{/t}</label>
				        <div class="controls">
							...
							{/if}
							<span class="input-must"><span class="require-field" style="color:#FF0000,">*</span></span>
							<span class="help-block">{t domain="adsense"}菜单组调用标识，且在同一地区下该标识不可重复。{/t}</span>
						</div>
			        </div>
			      
			        <div class="control-group formSep">
			        	<label class="control-label">{t domain="adsense"}菜单组描述：{/t}</label>
			          	<div class="controls">
			        ...
			        <div class="control-group formSep">
			        	<label class="control-label">{t domain="adsense"}可展示数量最大值：{/t}</label>
			          	<div class="controls">
			            	...
			            	<span class="help-block">{t domain="adsense"}在此可设置前台调用该菜单组的快捷菜单显示数量。{/t}</span>
			            </div>
			        </div>	
			        ...
			        <div class="control-group">
			        	<div class="controls">
			        		{if $data.position_id}
			        			...
			        			<a class="copy ecjiafc-red" style="cursor: pointer;" data-msg='{t domain="adsense"}您确定要进行复制该菜单组信息吗？{/t}' data-href='{url path="adsense/admin_shortcut/copy" args="position_id={$position_id}"}' title='{t domain="adsense"}复制{/t}'><button class="btn" type="button">{t domain="adsense"}复制{/t}</button></a>
			        		{else}
								...
								<div class="accordion-inner">
									...
									<div class="control-group control-group-small formSep">
							        	...
							        	<div class="controls">
											...
											<span class="help-block">{t domain="adsense"}建议菜单组宽度单位为Px{/t}</span>
										</div>
							        </div>
							  		...
							  		<div class="control-group control-group-small">
							        	...
							        	<div class="controls">
						            		...
						            		<span class="help-block">{t domain="adsense"}建议菜单组高度单位为Px{/t}</span>
						            	</div>
							        </div>
								</div>
							</div>
