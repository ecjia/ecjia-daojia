...
;
(function (app, $) {
    app.platform_request = {
        init: function () {
            //			app.platform_request.data();
            app.platform_request.search();
                    ...
                    if (counts === null) {
                        ...
                        if (type == 4) {
                            ...
                            var chart = new AChart({
                                ...
                                xAxis: {
                                    categories: [js_lang.Monday, js_lang.Tuesday, js_lang.Wednesday, js_lang.Thursday, js_lang.Friday, js_lang.Saturday, js_lang.Sunday,],
                                },
                                seriesOptions: { //设置多个序列共同的属性
                                    lineCfg: { //不同类型的图对应不同的共用属性，lineCfg,areaCfg,columnCfg等，type + Cfg 标示
                                        smooth: true
