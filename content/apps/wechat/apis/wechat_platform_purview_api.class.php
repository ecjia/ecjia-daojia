...
class wechat_platform_purview_api extends Component_Event_Api
{
    ...
    public function call(&$options)
    {
        $purviews = array(
            ...
            array('action_name' => __('客服会话管理', 'wechat'), 'action_code' => 'wechat_customer_session_manage', 'relevance' => ''),
            array('action_name' => __('客服会话更新', 'wechat'), 'action_code' => 'wechat_customer_session_update', 'relevance' => ''),
            array('action_name' => __('客服会话删除', 'wechat'), 'action_code' => 'wechat_customer_session_delete', 'relevance' => ''),
        );
        return $purviews;
    }
}
