 ...
 * @author royalwang
 */
class wechat_user_remove_cleardata_api extends Component_Event_Api
{
    ...
    public function call(& $options)
    {
        ...
        if (empty($user_id)) {
            return new ecjia_error('invalid_parameter', __('请求接口wechat_user_remove_cleardata_api参数无效', 'wechat'));
        }
