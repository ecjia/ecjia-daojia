...
class UserWechatAccountClear extends UserCleanAbstract
{
     ...
     * @var string
     */
    protected $code = 'user_wechat_account_clear';
...
HTML;
    ...
    {
        $count = RC_DB::table('wechat_user')->where('ect_uid', $this->user_id)->count();
    ...
    public function handleAdminLog()
    {
        ...
        ecjia_admin::admin_log($user_name, 'clean', 'user_wechat_account');
    }
