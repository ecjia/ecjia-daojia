...
class platform_response extends ecjia_platform
{
    ...
    public function reply_subscribe_insert()
    {
        ...
        if (empty($id)) {
            ...
            if ($reply_type == 'text') {
                $this->admin_log($content . '，' . RC_Lang::get('wechat::wechat.reply_type_character'), 'add', 'reply_subscribe');
            } elseif ($reply_type == 'image') {
                $this->admin_log($file . '，' . RC_Lang::get('wechat::wechat.reply_type_picture'), 'add', 'reply_subscribe');
            } elseif ($reply_type == 'voice') {
                $this->admin_log($file . '，' . RC_Lang::get('wechat::wechat.reply_type_voice'), 'add', 'reply_subscribe');
            } elseif ($reply_type == 'video') {
                $this->admin_log($file . '，' . RC_Lang::get('wechat::wechat.reply_type_video'), 'add', 'reply_subscribe');
            }
            if ($id) {
            ...
            if ($reply_type == 'text') {
                $this->admin_log($content . '，' . RC_Lang::get('wechat::wechat.reply_type_character'), 'edit', 'reply_subscribe');
            } elseif ($reply_type == 'image') {
                $this->admin_log($file . '，' . RC_Lang::get('wechat::wechat.reply_type_picture'), 'edit', 'reply_subscribe');
            } elseif ($reply_type == 'voice') {
                $this->admin_log($file . '，' . RC_Lang::get('wechat::wechat.reply_type_voice'), 'edit', 'reply_subscribe');
            } elseif ($reply_type == 'video') {
                $this->admin_log($file . '，' . RC_Lang::get('wechat::wechat.reply_type_video'), 'edit', 'reply_subscribe');
            }
