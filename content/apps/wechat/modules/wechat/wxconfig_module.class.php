...
class wechat_wxconfig_module extends api_front implements api_interface
{
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request)
    {
        $this->authSession();
        $uuid = $this->requestData('uuid');
        $share_url = $this->requestData('share_url');

        if (empty($share_url)) {
            return new ecjia_error('invalid_parameter', sprintf(__('请求接口%s参数无效', 'wechat'), __CLASS__));
        }
