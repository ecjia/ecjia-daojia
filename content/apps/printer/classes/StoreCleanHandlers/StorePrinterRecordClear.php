...
class StorePrinterRecordClear extends StoreCleanAbstract
{
    ...
    {
        $text = __('店铺内所有小票机的打印记录全部删除', 'printer');
...
HTML;
    ...
    {
        $count = RC_DB::table('printer_printlist')->where('store_id', $this->store_id)->count();
    ...
    public function handleClean()
    {
        ...
        $result = RC_DB::table('printer_printlist')->where('store_id', $this->store_id)->delete();
    ...
    public function handleAdminLog()
    {
        ...
        ecjia_admin::admin_log($merchants_name, 'clean', 'store_print_record');
    }
