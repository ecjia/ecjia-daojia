			        ...
			        <div class="panel-customize">
			            <div class="panel-body">
			                ...
			                <div class="footer-realestates-columns">
			                    <div class="row">
			                    	<div class="col-sm-6">
			                           <a href='{url path="staff/merchant/add" args="group_id=0&step=1"}' class="btn btn-primary btn-block">{t domain="staff"}新增账号{/t}</a>
			                        </div>
			                        <div class="col-sm-6">
				        ...
				        <div class="panel-customize">
				            <div class="panel-body">
				                ...
				                <div class="footer-realestates-columns">
				                    <div class="row">
				                    	<div class="col-sm-6">
				                           <a href='{url path="staff/merchant/add" args="group_id={$list.group_id}&step=1"}' class="btn btn-primary btn-block">{t domain="staff"}新增账号{/t}</a>
				                        </div>
				                        <div class="col-sm-6">
