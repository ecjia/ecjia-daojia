...
class promotion_merchant_menu_api extends Component_Event_Api {
	...
	public function call(&$options) {	
		...
		$submenus = array(
			ecjia_merchant::make_admin_menu('01_promotion_manage', __('促销商品', 'promotion'), RC_Uri::url('promotion/merchant/init'), 1)->add_purview('promotion_manage')->add_icon('fa-table'), //'promotion_manage'
		);
