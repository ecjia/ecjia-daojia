		...
		<table class="table table-striped table-hide-edit">
			...
			<tr>
				...
				<td class="hide-edit-area">
					...
					<div class="edit-list">
						<a data-toggle="ajaxremove" class="ajaxremove ecjiafc-red" data-msg='{t domain="promotion"}您确定要删除该促销活动吗？{/t}' href='{RC_Uri::url("promotion/admin/remove", "id={$item.goods_id}")}' title='{t domain="promotion"}删除{/t}'>{t domain="promotion"}删除{/t}</a>
				    </div>
				</td>
			...
			<!-- {foreachelse} -->
			<tr><td class="no-records" colspan="6">{t domain="promotion"}没有找到任何记录{/t}</td></tr>
			<!-- {/foreach} -->
		</table>
		<!-- {$promotion_list.page} -->
	</div>
