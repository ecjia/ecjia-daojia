...
<div>
	<h3 class="heading">
		...
		<!-- {/if} -->
		<a class="all_close plus_or_reply" data-msg="您确定要关闭全部推送消息事件吗？" data-href='{url path="push/admin_events/all_close"}'><button class="btn" type="button">全部关闭</button></a>     
	    <a class="all_open plus_or_reply"  data-msg="您确定要开启全部推送消息事件吗？" data-href='{url path="push/admin_events/all_open"}'><button class="btn btn-gebo" type="button">全部开启</button></a>     
	</h3>
</div>
