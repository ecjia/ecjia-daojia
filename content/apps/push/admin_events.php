...
class admin_events extends ecjia_admin {
	...
	public function init () {
		...
		ecjia_screen::get_current_screen()->add_nav_here(new admin_nav_here('消息事件'));
		$this->assign('ur_here', '消息事件列表');
	...
	public function open() {
		...
		return $this->showmessage('开启成功', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('push/admin_events/init')));
	}
	...
	public function close() {
		...
		return $this->showmessage('关闭成功', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('push/admin_events/init')));
	}
	...
	public function all_close() {
		...
		return $this->showmessage('全部关闭成功', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('push/admin_events/init')));
	}
