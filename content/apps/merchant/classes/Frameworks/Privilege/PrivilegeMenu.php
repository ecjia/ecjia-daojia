...
namespace Ecjia\App\Merchant\Frameworks\Privilege;
...
class PrivilegeMenu extends RC_Object
{
    ...
    {
        if (defined('RC_SITE')) {
            $this->cacheKey = 'merchant_privilege_menus' . constant('RC_SITE');
        } else {
            $this->cacheKey = 'merchant_privilege_menus';
        }
    }
    ...
    public function Menus()
    {
        ...
        $menus   = $this->loadMenu($apps, 'merchant_privilege_menu');
