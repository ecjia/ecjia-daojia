 ...
 * zrl
 */
class refund_returnway_shop_module extends api_front implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {	
		...
		if (!in_array('shop', $return_shipping_range)) {
			return new ecjia_error('return_shipping_range_error', __('当前申请不支持到店退货返还方式！', 'refund'));
		}
