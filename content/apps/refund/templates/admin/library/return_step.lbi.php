		...
		<ul>
			<li class="step-first">
				<div class="{if $refund_info.status eq '0'}step-cur{else}step-done{/if}">
					...
					<div class="m_t5">买家申请退货退款<br><font class="ecjiafc-blue">{if $refund_info.add_time}{$refund_info.add_time}{/if}</font></div>	
				</div>
			</li>
			...
			<li>
				<div class="{if $refund_info.return_status gt '1'}step-done{elseif $refund_info.status gt '0'}step-cur{/if}">
					...
					{/if}
					<div class="m_t5">商家处理退款申请<br><font class="ecjiafc-blue">{if $action_mer_msg_return.log_time}{$action_mer_msg_return.log_time}{/if}</font></div>
				</div>
			</li>
			...
			<li>
				<div class="{if $refund_info.return_status gt '2'}step-done{elseif $refund_info.return_status eq '2'}step-cur{/if}">
					...
					<div class="m_t5">买家退货给商家<br><font class="ecjiafc-blue">{if $refund_info.return_time}{$refund_info.return_time}{/if}</font></div>
				</div>
			</li>
			...
			<li>
				<div class="{if $refund_info.refund_status eq '2'}step-done{elseif $refund_info.return_status gt '2'}step-cur{/if}">
				    ...
				    {/if}
					<div class="m_t5">商家确认收货<br><font class="ecjiafc-blue">{if $action_mer_msg_confirm.log_time}{$action_mer_msg_confirm.log_time}{/if}</font></div>
				</div>
			</li>
