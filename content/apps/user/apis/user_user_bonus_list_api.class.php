            ...
            foreach ($rows as $key => $row) {
                ...
                if (empty($row['order_id'])) {
                    ...
                    if ($row['use_start_date'] > $cur_date) {
                        ...
                        $bonus_list[$key]['label_status'] = __('未开始', 'user');

                    } else if ($row['use_end_date'] < $cur_date) {
                        $bonus_list[$key]['status']       = 'expired';
                        $bonus_list[$key]['label_status'] = __('已过期', 'user');
                    } else {
                        $bonus_list[$key]['status']       = 'allow_use';
                        $bonus_list[$key]['label_status'] = __('可使用', 'user');
                    }
                } else {
                    $bonus_list[$key]['status']       = 'is_used';
                    $bonus_list[$key]['label_status'] = __('已使用', 'user');
                }
            }
        }
