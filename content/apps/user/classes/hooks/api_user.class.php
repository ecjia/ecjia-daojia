...
RC_Hook::add_action( 'ecjia_user_login_after', array('user_api_hooks', 'record_user_session_logins') );
RC_Hook::add_action( 'ecjia_user_logout_before', array('user_api_hooks', 'user_session_logout_remove') );
