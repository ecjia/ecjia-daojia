...
class AdminTemplateController extends AdminBase
{
    ...
    public function init()
    {
        ...
        $data = RC_DB::connection(config('ecjia.database_connection', 'default'))
    ...
    public function add()
    {
        ...
        ecjia_screen::get_current_screen()->set_help_sidebar(
            ...
            '<p>' . __('<a href="https://ecjia.com/wiki/帮助:ECJia智能后台:短信模板#.E6.B7.BB.E5.8A.A0.E7.9F.AD.E4.BF.A1.E6.A8.A1.E6.9D.BF" target="_blank">' . __('关于添加短信模板帮助文档', 'sms') . '</a>', 'sms') . '</p>'
        );
    ...
    public function edit()
    {
        ...
        ecjia_screen::get_current_screen()->set_help_sidebar(
            '<p><strong>' . __('更多信息：', 'sms') . '</strong></p>' .
            '<p>' . __('<a href="https://ecjia.com/wiki/帮助:ECJia智能后台:短信模板#.E7.BC.96.E8.BE.91.E7.9F.AD.E4.BF.A1.E6.A8.A1.E6.9D.BF" target="_blank">' . __('关于编辑短信模板帮助文档', 'sms') . '</a>', 'sms') . '</p>'
        );
