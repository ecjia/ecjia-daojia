    ...
    app.sms_config_edit = {
        ...
        submit_form: function (formobj) {
            ...
            var option = {
                ...
                messages: {
                    sms_user_name: {
                        required: js_lang_sms_config.sms_user_name_required
                    },
                    sms_password: {
                        required: js_lang_sms_config.sms_password_required,
                        minlength: js_lang_sms_config.sms_password_minlength
                    }
                },
