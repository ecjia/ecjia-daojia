...
class admin_touch_hooks {
   ...
   public static function append_admin_setting_group($menus) 
   {
       ...
       $menus[] = ecjia_admin::make_admin_menu('nav-header', 'H5应用', '', 100)->add_purview(array('mobile_config_manage', 'mobile_manage'));
       $menus[] = ecjia_admin::make_admin_menu('wap', $setting->cfg_name_langs('wap'), RC_Uri::url('setting/shop_config/init', array('code' => 'wap')), 101)->add_purview('shop_config')->add_icon('fontello-icon-tablet');
