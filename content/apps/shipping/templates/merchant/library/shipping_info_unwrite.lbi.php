...
{if $shipping_data.shipping_code eq 'ship_o2o_express' || $shipping_data.shipping_code eq 'ship_ecjia_express'}
	<div class="form-group" id="ship_days">
		...
		<div class="controls col-lg-6">
			<input class="form-control col-lg-3" name="ship_days" placeholder="请填写有效天数，最小单位为1" type="text" value="{$ship_days}" readonly/>
		</div>
		<div class="clear">
	...
	<div class="form-group" id="last_order_time">
		...
		<div class="controls col-lg-6">
			<input class="form-control" name="last_order_time" placeholder="最小单位为分钟；如30" type="text" value="{$last_order_time}" readonly/>
	...
	<div class="form-group" id="ship_time">
		...
		<!-- {foreach from=$o2o_express item=express name=e} -->
			<div class='time-picker'>
				距离&nbsp;&nbsp;<input class="w100 form-control" name="express_distance[]" type="text" value="{$express.express_distance}" autocomplete="off" readonly/>&nbsp;&nbsp;公里&nbsp;&nbsp;
				配送费&nbsp;&nbsp;<input class="w100 form-control" name="express_money[]" type="text" value="{$express.express_money}" autocomplete="off" readonly/>&nbsp;&nbsp;元&nbsp;&nbsp;
			</div> 
		<!-- {foreachelse} --> 
			<div class='time-picker'>
				距离&nbsp;&nbsp;<input class="w100 form-control" name="express_distance[]" type="text" readonly/>&nbsp;&nbsp;公里&nbsp;&nbsp;
				配送费&nbsp;&nbsp;<input class="w100 form-control" name="express_money[]" type="text" readonly/>&nbsp;&nbsp;元&nbsp;&nbsp;
			</div> 
		<!-- {/foreach} --> 
...
{if $shipping_data.shipping_code eq 'ship_cac'}
	<div class="form-group" id="pickup_days">
		...
		<div class="controls col-lg-4">
			<input class="form-control col-lg-3" name="pickup_days" placeholder="请填写有效天数，最小单位为1" type="text" value="{$pickup_days}" readonly/>
		</div>
		<div class="clear">
			<label class="control-label col-lg-4"></label>
