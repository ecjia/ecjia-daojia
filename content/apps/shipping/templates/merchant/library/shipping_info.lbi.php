	...
	<div class="form-group" id="ship_time">
		...
		<div class="col-lg-6">
			<!-- {foreach from=$cac_pickup_time key=key item=pickup_time} -->
		 		<!-- {if $key eq 0} -->
					<div class="time-picker">
						{t domain="shipping"}从{/t}&nbsp;&nbsp;<input type="text" name="start_pickup_time[]" value="{$pickup_time.start}" class="w100 form-control"/>&nbsp;&nbsp;
						{t domain="shipping"}至{/t}&nbsp;&nbsp;<input type="text" name="end_pickup_time[]"  value="{$pickup_time.end}"  class="w100 form-control" />&nbsp;&nbsp;
