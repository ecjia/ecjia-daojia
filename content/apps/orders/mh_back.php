...
class mh_back extends ecjia_merchant
{
    public function __construct()
    {
        ...
        ecjia_screen::get_current_screen()->add_nav_here(new admin_nav_here(__('退货单列表', 'orders'), RC_Uri::url('orders/mh_back/init')));
    ...
    public function remove()
    {
        ...
        /* 记录日志 */
        ecjia_admin_log::instance()->add_object('order_back', __('退货单', 'orders'));
        ...
        return $this->showmessage(__('退货单删除成功！', 'orders'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('orders/mh_back/init')));
    }
