...
<table width="100%" border="0">
	<tr align="right">
		<td>
			...
			{/if}
			<!-- 订单总金额 -->
			= 订单总金额：{$order.formated_total_fee}
		</td>
	</tr>
	<tr align="right">
		<td>
			<!-- 如果已付了部分款项, 减去已付款金额 -->
			{if $order.money_paid neq '0.00'}- 已付款金额：{$order.formated_money_paid}{/if}
			<!-- 如果使用了余额支付, 减去已使用的余额 -->
			{if $order.surplus neq '0.00'}- 使用余额：{$order.formated_surplus}{/if}
			<!-- 如果使用了积分支付, 减去已使用的积分 -->
...
<table width="100%" border="0">
	...
	<tr><!-- 网店名称, 网店地址, 网店URL以及联系电话 -->
		<td>
            ...
            地址：{$shop_address}&nbsp;&nbsp;电话：{$service_phone}
		</td>
	</tr>
