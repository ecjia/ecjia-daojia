			...
			<div class="panel-body">
				<header class="panel-title">
					...
					<span class="pull-right">
						<a target="__blank" href="{RC_Uri::url('commission/merchant/init')}">{t domain="orders"}查看更多 >>{/t}</a>
					</span>
				</header>
		...
		<div class="panel">
			<div class="panel-body">
				<header class="panel-title">
					...
					<span class="pull-right">
						<a target="__blank" href="{RC_Uri::url('orders/mh_order_stats/init')}">{t domain="orders"}查看更多 >>{/t}</a>
					</span>
				</header>
				<div class="task-progress-content">
					<div class="item-column">
		...
		<div class="panel">
			<div class="panel-body">
				<header class="panel-title m_b10">{t domain="orders"}商品热卖榜{/t}</h1>
					<span class="pull-right">
						<a target="__blank" href="{RC_Uri::url('orders/mh_sale_order/init')}">{t domain="orders"}查看更多 >>{/t}</a>
					</span>
				</header>
