        		...
        		<ul class="nav navbar-nav float-right">         
          			<li class="dropdown dropdown-language nav-item">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                        	<a class="dropdown-item" href="#"><i class="flag-icon flag-icon-cn"></i> {t domain="platform"}简体中文{/t}</a>
                        </div>
          			</li>
          			...
          			<li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                        	<a class="dropdown-item" href="{$currentUser->getProfileSettingUrl()}"><i class="ft-user"></i> {t domain="platform"}个人设置{/t}</a>
                          	<div class="dropdown-divider"></div>
                          	<a class="dropdown-item" href="{url path='platform/privilege/logout'}"><i class="ft-power"></i> {t domain="platform"}退出{/t}</a>
                    	</div>
          			</li>
        		</ul>
      		</div>
