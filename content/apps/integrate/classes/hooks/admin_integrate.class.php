...
class integrate_admin_hooks
{
    public static function integrate_admin_menu_api($menus)
    {
        $menus->add_submenu([
...
RC_Hook::add_action('user_admin_menu_api', array('integrate_admin_hooks', 'integrate_admin_menu_api'));
