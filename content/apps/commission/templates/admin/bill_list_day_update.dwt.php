...
<div class="alert alert-info">
	...
	<strong>温馨提示：</strong>{t}数据量较大情况会比较慢，请耐心等耐。{/t}
</div>
<div>
	<h3 class="heading">
				...
				<form class="form-horizontal" id="form-privilege" name="theForm" action="{$form_action}" method="post" enctype="multipart/form-data" >
        			<fieldset>
        			    <div class="control-group formSep">
        					...
        					<div class="controls">
        						<input class="form-control start_date" name="start_date" type="text" placeholder="开始时间" value="{$smarty.get.start_date}">
	    				<span class="">-</span>
	    				<input class="form-control end_date" name="end_date" type="text" placeholder="结束时间" value="{$smarty.get.end_date}">
