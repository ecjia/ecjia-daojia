        ...
        <form class="form-horizontal" id="form-privilege" name="theForm" action="{$form_action}" method="post" enctype="multipart/form-data" >
            <fieldset>
                <div class="control-group formSep">
                    ...
                    <div class="controls">
                        <input class="form-control" name="store_phone" type="text" placeholder="" value="">
                ...
                <div class="control-group formSep">
                    ...
                    <div class="controls">
                        <input class="form-control" name="amount" type="text" placeholder="{t domain="commission"}充值金额必须大于0的整数{/t}" value=""> {t domain="commission"}元{/t}
                        <span class="input-must">*</span>
                    </div>
                </div>
                <div class="control-group formSep">
                    ...
                    <div class="controls l_h30">
                        <span class="data-store-name">{t domain="commission"}现金{/t}</span>
                    </div>
                </div>
                ...
                <div class="control-group formSep">
                    ...
                    <div class="controls">
                        <textarea name="admin_note" style="margin-bottom: 10px;" class="span10 select-link-content" placeholder='{t domain="commission"}请输入退款备注{/t}'></textarea>
