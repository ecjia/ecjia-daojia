...
class commission_merchant_menu_api extends Component_Event_Api {
	...
	public function call(&$options) {
		...
		$menus = ecjia_merchant::make_admin_menu('07_commission', __('结算', 'commission'), '', 7)->add_icon('fa-money')->add_purview(array('commission_manage', 'commission_month','commission_day','commission_order','commission_count'))->add_base('commission');
