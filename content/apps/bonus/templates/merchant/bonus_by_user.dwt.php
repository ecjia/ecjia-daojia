                ...
                <div class="form">
                    <form class="cmxform form-horizontal tasi-form form1" action="{$form_action}" method="post" name="userRankForm" class="form1" >
                        <div class=" form-group ">
                            <div class="col-lg-12">
                                <strong>{t domain="bonus"}按用户等级发放红包{/t}</strong>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <label for="validated_email">{t domain="bonus"}只给通过邮件验证的用户发放红包{/t}</label>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12">
                ...
                <form class="cmxform form-horizontal tasi-form" action='{$form_user_action}' method="post" name="theForm">
                    <div class="tab-content">
                        <fieldset>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <label>{t domain="bonus"}按指定用户发放红包{/t}</label>
                                </div>
                            </div>
                            <div class="form-group choose_lists"  id="search_user"  data-url="{url path='bonus/merchant/search_users'}">
                                ...
                                <div class="col-lg-12 m_t5">
                                    {t domain="bonus"}搜索要发放此类型红包的用户展示在左侧区域中，点击左侧列表中选项，用户即可进入右侧发放红包区域。您还可以在右侧编辑将发放红包的用户。{/t}
                                </div>
