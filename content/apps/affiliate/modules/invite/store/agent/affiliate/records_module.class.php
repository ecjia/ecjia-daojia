 ...
 * @author zrl
 */
class invite_store_agent_affiliate_records_module extends api_front implements api_interface
{
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request)
    {
        ...
        $status = $this->requestData('status', 'await_separate');
        ...
        $collection = (new \Ecjia\App\Affiliate\AffiliateStore\Collections\AffiliateOrderCommissionCollection($agent_id, $filter))->getData();

        return ['data' => $collection['list'], 'pager' => $collection['pager']];
    }
}
