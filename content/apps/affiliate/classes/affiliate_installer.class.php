    ...
    public function install() {
    	...
    	if (!RC_Model::make()->table_exists($invite_reward_table)) {
    		$schemes = array(
    				...
    				"`invitee_name` varchar(60) NULL COMMENT '被邀请人名称'",
    				"`reward_type` varchar(10) NULL COMMENT '奖励类型（红包：bouns，积分：integral，余额：balance）'",
    				"`reward_value` varchar(100) NULL COMMENT '获得的奖励'",
    				"`reward_desc` varchar(100) NULL COMMENT '奖励补充描述说明'",
    	...
    	if (!RC_Model::make()->table_exists($invitee_record_table)) {
    		$schemes = array(
    			"`id` int(11) unsigned NOT NULL AUTO_INCREMENT",
    			"`invite_id` int(11) unsigned NOT NULL",
    			"`invitee_phone` char(11) NULL COMMENT '受邀者手机号'",
    			"`invite_type` varchar(10) NULL",
