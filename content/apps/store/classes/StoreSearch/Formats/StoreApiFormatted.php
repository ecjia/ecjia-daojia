...
namespace Ecjia\App\Store\StoreSearch\Formats;


use Ecjia\App\Store\Models\StoreFranchiseeModel;

class StoreApiFormatted
{
    ...
    public function __construct(StoreFranchiseeModel $model, $user_rank_discount = 1, $user_rank = 0)
    {
        $this->model = $model;
