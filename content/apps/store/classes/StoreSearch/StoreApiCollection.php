...
use Ecjia\App\Store\StoreSearch\Formats\StoreApiFormatted;
use Royalcms\Component\Http\Request;

class StoreApiCollection
{
    protected $input = [];
    ...
    public function getData()
    {
        ...
        if ($page) {
            ...
            $count = StoreSearch::singleton()->applyCount($this->request);
        ...
        $collection = StoreSearch::singleton()->apply($this->request, function($query) use ($user_rank) {
            /**
        ...
        $collection = $collection->map(function($item) use ($user_rank_discount, $user_rank) {
            return (new StoreApiFormatted($item, $user_rank_discount, $user_rank))->toArray();
        });
    ...
    public static function test()
    {
         ...
         $collection = (new StoreApiCollection($input))->getData();
