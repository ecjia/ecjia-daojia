			...
			<ul class="m_l0">
				...
				<li class="thumbnail" style="margin-left:35px; margin-bottom:15px; width:200px;height:210px;" >
					...
					<p style="margin-top: -5px;">
						<a href='{url path="theme/admin_layout_backup/restore_backup" args="remarks={$remarks.url}"}' title="{t}还原{/t}"><i class="fontello-icon-arrows-cw"></i>还原</a>
						<a href='{url path="theme/admin_layout_backup/delete" args="remarks={$remarks.url}"}' title="{t}删除{/t}" ><i class="fontello-icon-trash"></i>删除</a>
					</p>
				</li>
				<!-- {foreachelse} -->
