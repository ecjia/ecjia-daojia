...
class BestGoods extends ComponentAbstract
{
     ...
     * @var string
     */
    protected $code = 'best_goods';

    /**
     * 名称
     * @var string
     */
    protected $name = '首页推荐商品';

    /**
     * 描述
     * @var string
     */
    protected $description = '首页推荐商品，最多支持10个。';

    /**
     * 缩略图
     * @var string
     */
    protected $thumb = '/statics/images/thumb/module_bestgoods.png'; //图片未添加
