...
class stats_merchant_menu_api extends Component_Event_Api {
	...
	public function call(&$options) {
		...
		$menus = ecjia_merchant::make_admin_menu('13_stats',__('报表统计'), '', 5)->add_icon('fa-bar-chart-o')->add_purview(array('stats_search_keywords','order_stats','sale_general_stats','sale_list_stats','sale_order_stats'))->add_base('stats');
