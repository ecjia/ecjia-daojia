                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="chk_radio">
                                    ...
                                    <input class="uni_style" type="radio" name="payment" value="{$val.withdraw_code}" {if $val.is_checked}checked="true"{/if}/><span>{$val.withdraw_name}</span>
                                    {/foreach}
                                    <input type="hidden"  name="old_withdraw_way" value="{$account_info.payment}" />
                                </div>
                            </td>
                        </tr>
