 ...
 * ECJIA微信登录配置
 */
class platform_wechat_login extends ecjia_platform
{
    public function __construct()
    {
        ...
        ecjia_platform_screen::get_current_screen()->add_nav_here(new admin_nav_here(__('微信登录配置', 'weapp'), RC_Uri::url('weapp/platform_wechat_login/init')));
        ecjia_platform_screen::get_current_screen()->set_subject(__('微信登录配置', 'weapp'));
    }
    ...
    public function init()
    {
        ...
        ecjia_platform_screen::get_current_screen()->add_nav_here(new admin_nav_here(__('微信登录配置', 'weapp')));
        ...
        $this->assign('ur_here', __('微信登录配置', 'weapp'));
        $this->assign('form_action', RC_Uri::url('weapp/platform_wechat_login/update'));
    ...
    public function update()
    {
        ...
        $sns_wechat_callback = trim($_POST['sns_wechat_callback']);
