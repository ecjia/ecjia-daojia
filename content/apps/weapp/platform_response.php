...
class platform_response extends ecjia_platform
{
    public function __construct()
    {
        ...
        RC_Script::enqueue_script('platform_response', RC_App::apps_url('statics/platform-js/platform_response.js', __FILE__), array(), false, true);
        ...
        RC_Script::localize_script('platform_response', 'js_lang', RC_Lang::get('wechat::wechat.js_lang'));
    ...
    public function reply_keywords_insert()
    {
        ...
        if (!empty($id)) {
            $this->admin_priv('weapp_response_update', ecjia::MSGTYPE_JSON);
            $this->admin_priv('weapp_response_delete', ecjia::MSGTYPE_JSON);
