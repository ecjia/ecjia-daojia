...
<div class="alert alert-light alert-dismissible mb-2" role="alert">
    ...
    <p>{t domain="weapp"}三、打开客服回复：即打开客服时自动回复一条设置好的文字或图片。{/t}</p>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link data-pjax active" href='{url path="weapp/platform_response/open_reply"}'>{t domain="weapp"}打开客服回复{/t}</a>
                    </li>
                </ul>
