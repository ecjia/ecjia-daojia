            ...
            <ul class="wookmark-goods-photo move-mod nomove">
                ...
                <li class="thumbnail move-mod-group">
                    ...
                    <p>
                        ...
                        <a href="javascript:;" title="{lang key='wechat::wechat.save'}" data-toggle="sort-ok" data-imgid="{$val.id}" data-saveurl="{url path='weapp/platform_material/edit_file_name' args='type=picture'}" style="display:none;"><i class="fa fa-check"></i></a>
                        <a class="ajaxremove" data-imgid="{$val.id}" data-toggle="ajaxremove" data-msg="{lang key='wechat::wechat.remove_images_material'}" href='{url path="weapp/platform_material/picture_remove" args="id={$val.id}"}' title="{lang key='wechat::wechat.delete'}"><i class="ft-trash-2"></i></a>
                ...
                <li class="thumbnail move-mod-group">
                    ...
                    <p>
                        <a href="javascript:;" title="{lang key='wechat::wechat.cancel'}" data-toggle="sort-cancel" style="display:none;"><i class="fa fa-times"></i></a>
                        <a href="javascript:;" title="{lang key='wechat::wechat.save'}" data-toggle="sort-ok" data-imgid="{$article.id}" data-saveurl="{url path='weapp/platform_material/edit_file_name' args='type=picture'}" style="display:none;"><i class="fa fa-check"></i></a>
                        <a class="ajaxremove" data-imgid="{$article.id}" data-toggle="ajaxremove" data-msg="{lang key='wechat::wechat.remove_images_material'}" href='{url path="weapp/platform_material/picture_remove" args="id={$article.id}"}' title="{lang key='wechat::wechat.cancel'}"><i class="ft-trash-2"></i></a>
                        <a href="javascript:;" title="{lang key='wechat::wechat.edit'}" data-toggle="edit"><i class="ft-edit-2"></i></a>
