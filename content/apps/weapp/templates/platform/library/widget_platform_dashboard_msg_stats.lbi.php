...
<div class="card weui-desktop-panel weui-desktop-panel_overview">
    <div class="card-header">
        <h4 class="card-title">{t domain="weapp"}用户发送消息{/t}</h4>
    </div>
        ...
        <ul id="list" class="weui-desktop-mass">
            ...
            <li class="weui-desktop-mass__item">
                ...
                <div class="weui-desktop-mass__content">
                    <a href="{RC_Uri::url('weapp/platform_user/subscribe_message')}&uid={$v.uid}" target="_blank">
                        <div class="weui-desktop-mass-media weui-desktop-mass-appmsg">
                            ...
                            <div class="weui-desktop-mass-appmsg__bd">
                                <span class="weui-desktop-mass-appmsg__title">{$v.msg}</span>
                            </div>
                            <div class="weui-desktop-mass-media__data-list">
                                <span class="weui-desktop-mass-appmsg__title">{$v.send_time_detail}</span>
                            </div>
                        </div>
                    </a>
                </div>
