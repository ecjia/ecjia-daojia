						...
						<tr class="big">
							...
							<td class="hide-edit-area">
								...
								<div class="edit-list">
									...
									<a class="ajaxremove cursor_pointer" href='{RC_Uri::url("weapp/platform_user/unblack_user","openid={$val.openid}")}' title="{lang key='wechat::wechat.remove_blacklist'}" data-toggle="ajaxremove" data-msg="{lang key='wechat::wechat.remove_blacklist_confirm'}">取消黑名单</a>
									<!-- {/if} -->
								</div>
							</td>
