 ...
 *
 */
class shop_special_readme_userdelete_module extends api_front implements api_interface {
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request) {
    	
		$article_info = RC_DB::table('article')->where('title', '注销须知')->where('article_approved', 1)->where( 'article_type', 'system')->first();
