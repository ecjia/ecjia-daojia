        ...
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            <div class="column-14 start-06 ecjia-install">
                <form method="post" action='{RC_Uri::url("installer/index/detect")}'>
                    <h3 class="ecjia-install-title">{t domain="installer"}欢迎使用{/t} ECJIA到家</h3>
                    <div class="ecjia-install-body">
                        {t domain="installer" escape=no}<h4>安装说明</h4>
                        ...
                        <p>请您在安装前仔细阅读本协议内容。<br>
                            感谢您选择上海商创网络科技有限公司（模板堂）独立研发ECJia到家新零售商城系统，即ECJia到家。在我们的不断努力中，为用户提供全新，功能强大，使用便捷的O2O产品。<br>
                            模板堂是ECJia到家新零售商城系统的开发商，ECJia官方网站为 <a href="https://ecjia.com/" target="_blank">https://ecjia.com/</a>。<br>
                        ...
                        <p>ECJIA到家软件由上海商创网络科技有限公司提供支持，核心开发团队负责维护程序日常开发工作以及新特性的制定。如果您遇到使用上的问题，程序中的 BUG，以及期许的新功能，欢迎您在社区中交流或者直接向我们贡献代码。对于贡献突出者，他的名字将出现在贡献者名单中。</p>{/t}
                    </div>
                    ...
                    <p class="submit">
                        <button type="submit" class="btn primary" id="ecjia_install" disabled="disabled">{t domain="installer"}我准备好了，开始下一步{/t} &raquo;</button>
                    </p>
                </form>
            </div>
        </div>
