        ...
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            <div class="column-14 start-06 ecjia-install-complete">
                ...
                <div class="typecho-install-body">
                    ...
                    <ul>  
                    	<li><a target="_blank" href="{$index_url}">{t domain="installer"}点击这里进入ECJIA到家首页{/t}</a></li>
                    	<li><a target="_blank" href="{$h5_url}">{t domain="installer"}点击这里进入ECJIA到家H5端{/t}</a></li>
                    	<li><a target="_blank" href="{$admin_url}">{t domain="installer"}点击这里进入ECJIA到家平台后台{/t}</a></li>
                        <li><a target="_blank" href="{$merchant_url}">{t domain="installer"}点击这里进入ECJIA到家商家后台{/t}</a></li>
                    </ul>
                    </div>
                    <p>{t domain="installer"}各种体验，希望您能尽情享用ECJIA到家带来的乐趣！{/t}</p>
                </div>
			</div>
		</div>
	</div>
