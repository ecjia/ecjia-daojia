...
CREATE TABLE `ecjia_ad` (
  ...
  `ad_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `ecjia_ad_position` (
  ...
  `position_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `ecjia_article` (
  ...
  `author_email` varchar(60) CHARACTER SET utf8mb4,
  `keywords` varchar(255) CHARACTER SET utf8mb4,
  `article_type` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `is_open` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `add_time` int(10) unsigned NOT NULL DEFAULT '0',
  `file_url` varchar(255) CHARACTER SET utf8mb4,
  `open_type` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `link` varchar(255) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_article_cat` (
  ...
  `keywords` varchar(255) CHARACTER SET utf8mb4,
  `cat_desc` varchar(255) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_attribute` (
  ...
  `attr_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `ecjia_back_order` (
  ...
  `order_sn` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `ecjia_bonus_type` (
  ...
  `store_id` int(10) unsigned NOT NULL DEFAULT '0',
  `type_name` varchar(60) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `ecjia_brand` (
  ...
  `brand_name` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `brand_logo` varchar(80) COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `ecjia_cart` (
  ...
  `goods_name` varchar(120) CHARACTER SET utf8mb4 NOT NULL,
  `market_price` decimal(10,2) unsigned NOT NULL DEFAULT '0.00',
  `goods_price` decimal(10,2) NOT NULL DEFAULT '0.00',
  `goods_number` smallint(5) unsigned NOT NULL DEFAULT '1',
  `goods_attr` text CHARACTER SET utf8mb4 NULL,
  `is_real` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `extension_code` varchar(30) CHARACTER SET utf8mb4,
  ...
  `goods_attr_id` varchar(255) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_category` (
  ...
  `cat_name` varchar(90) CHARACTER SET utf8mb4 NOT NULL,
  `category_img` varchar(255) CHARACTER SET utf8mb4,
  `keywords` varchar(255) CHARACTER SET utf8mb4,
  `cat_desc` varchar(255) CHARACTER SET utf8mb4,
  `parent_id` smallint(5) unsigned NOT NULL DEFAULT '0',
  `sort_order` tinyint(1) unsigned NOT NULL DEFAULT '50',
  `template_file` varchar(50) CHARACTER SET utf8mb4,
  `measure_unit` varchar(15) CHARACTER SET utf8mb4,
  `show_in_nav` tinyint(1) NOT NULL DEFAULT '0',
  `style` varchar(150) CHARACTER SET utf8mb4,
  `is_show` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
CREATE TABLE `ecjia_comment` (
  ...
  `add_time` int(10) unsigned NOT NULL DEFAULT '0',
  `ip_address` varchar(15) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_connect` (
  ...
  `connect_code` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `connect_name` varchar(120) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `ecjia_connect_user` (
  ...
  `connect_code` char(30) CHARACTER SET utf8mb4 NOT NULL,
  ...
  `access_token` char(64) COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `ecjia_crons` (
  ...
  `cron_code` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  ...
  `allow_ip` varchar(100) CHARACTER SET utf8mb4,
  `alow_files` varchar(255) CHARACTER SET utf8mb4,
  PRIMARY KEY (`cron_id`),
  KEY `nextime` (`nextime`),
  KEY `enable` (`enable`),
...
CREATE TABLE `ecjia_delivery_order` (
  ...
  `delivery_sn` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `order_sn` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `ecjia_express_order` (
  ...
  `from` char(10) COLLATE utf8mb4_unicode_ci COMMENT '来源：assign(派单)，grab(抢单)',
...
CREATE TABLE `ecjia_favourable_activity` (
  ...
  `store_id` int(10) unsigned NOT NULL DEFAULT '0',
  `act_name` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `start_time` int(10) unsigned NOT NULL,
  `end_time` int(10) unsigned NOT NULL,
  `user_rank` varchar(255) CHARACTER SET utf8mb4,
  `act_range` tinyint(3) unsigned NULL,
  `act_range_ext` varchar(255) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_goods` (
  ...
  `keywords` varchar(255) CHARACTER SET utf8mb4,
  `goods_brief` varchar(255) CHARACTER SET utf8mb4,
  `goods_desc` text CHARACTER SET utf8mb4 NULL,
  `goods_thumb` varchar(255) CHARACTER SET utf8mb4,
  `goods_img` varchar(255) CHARACTER SET utf8mb4,
  `original_img` varchar(255) CHARACTER SET utf8mb4,
  `is_real` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `extension_code` varchar(30) CHARACTER SET utf8,
  ...
  `seller_note` varchar(255) CHARACTER SET utf8,
...
CREATE TABLE `ecjia_goods_attr` (
  ...
  `attr_price` varchar(255) CHARACTER SET utf8mb4,
  `attr_sort` int(11) unsigned NULL,
  `attr_img_flie` varchar(255) CHARACTER SET utf8mb4,
  `attr_gallery_flie` varchar(255) CHARACTER SET utf8mb4,
  `attr_img_site` varchar(255) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_goods_type` (
  ...
  `attr_group` varchar(255) CHARACTER SET utf8mb4,
  PRIMARY KEY (`cat_id`),
...
CREATE TABLE `ecjia_keywords` (
  ...
  `searchengine` varchar(20) COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `ecjia_link_goods` (
  `goods_id` mediumint(8) unsigned NOT NULL,
  `link_goods_id` mediumint(8) unsigned NOT NULL,
...
CREATE TABLE `ecjia_mail_templates` (
  ...
  `template_code` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  `is_html` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `template_subject` varchar(200) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_mobile_manage` (
  ...
  `app_name` varchar(100) CHARACTER SET utf8mb4 NOT NULL COMMENT '应用名称',
...
CREATE TABLE `ecjia_order_info` (
  ...
  `longitude` varchar(20) COLLATE utf8mb4_unicode_ci NULL COMMENT '经度',
  `latitude` varchar(20) COLLATE utf8mb4_unicode_ci NULL COMMENT '纬度',
  `zipcode` varchar(60) CHARACTER SET utf8mb4,
  `tel` varchar(60) CHARACTER SET utf8mb4,
  `mobile` varchar(60) CHARACTER SET utf8mb4,
  `email` varchar(60) CHARACTER SET utf8mb4,
  `best_time` varchar(120) CHARACTER SET utf8mb4,
  `sign_building` varchar(120) CHARACTER SET utf8mb4,
  `postscript` varchar(255) CHARACTER SET utf8mb4,
  ...
  `how_oos` varchar(120) CHARACTER SET utf8mb4,
  `how_surplus` varchar(120) CHARACTER SET utf8mb4,
  `pack_name` varchar(120) CHARACTER SET utf8mb4,
  `card_name` varchar(120) CHARACTER SET utf8mb4,
  `card_message` varchar(255) CHARACTER SET utf8mb4,
  `inv_payee` varchar(120) CHARACTER SET utf8mb4,
  `inv_content` varchar(120) CHARACTER SET utf8mb4,
  ...
  `from_ad` smallint(5) NOT NULL DEFAULT '0',
  `referer` varchar(255) CHARACTER SET utf8mb4,
  `add_time` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `invoice_no` varchar(255) CHARACTER SET utf8mb4,
  `extension_code` varchar(30) CHARACTER SET utf8mb4,
  `extension_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `to_buyer` varchar(255) CHARACTER SET utf8mb4,
  `pay_note` varchar(255) CHARACTER SET utf8mb4,
  `agency_id` smallint(5) unsigned NULL,
  `inv_type` varchar(60) CHARACTER SET utf8mb4,
...
CREATE TABLE `ecjia_payment` (
  ...
  `pay_code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pay_name` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `ecjia_platform_account` (
  ...
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '公众号名称',
...
CREATE TABLE `ecjia_push_event` (
  ...
  `is_open` tinyint(3) NOT NULL DEFAULT '0' COMMENT '是否启用',
...
CREATE TABLE `ecjia_store_bill_paylog` (
  ...
  `payee` varchar(80) NOT NULL DEFAULT '' COMMENT '收款人',
  `bank_account_number` varchar(30) NOT NULL DEFAULT '' COMMENT '银行账号',
  `bank_name` varchar(40) NOT NULL DEFAULT '' COMMENT '收款银行',
  `bank_branch_name` varchar(40) DEFAULT '' COMMENT '开户银行支行名称',
...
CREATE TABLE `ecjia_user_account` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `order_sn` varchar(20) COLLATE utf8mb4_unicode_ci NULL COMMENT '订单编号',
