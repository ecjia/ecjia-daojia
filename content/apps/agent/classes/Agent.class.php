...
class Agent
{
    public static function get_agent_rank($rank_code = '')
    {
    ...
    public static function get_count_info($id)
    {
    ...
    public static function get_agent_info($id)
    {
