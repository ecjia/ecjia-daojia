...
;(function (app, $) {
    app.cashier_goods_info = {
        init: function () {
        	...
        	app.cashier_goods_info.set_allprice_note();
        	app.cashier_goods_info.add_volume_price();
        	app.cashier_goods_info.toggle_promote();
            app.cashier_goods_info.marketPriceSetted();
            app.cashier_goods_info.expire_date();
            app.cashier_goods_info.submit_info();
        },
        marketPriceSetted: function() {
			$('[data-toggle="marketPriceSetted"]').on('click', function(e) {
				...
				app.cashier_goods_info.computePrice(options);
				app.cashier_goods_info.set_allprice_note();
			})
		},
		...
		set_allprice_note: function() {
			if (admin_goodsList_lang.user_rank_list) {
				for (var i = admin_goodsList_lang.user_rank_list.length - 1; i >= 0; i--) {
					...
					app.cashier_goods_info.set_price_note(options);
				};
			}
		},
