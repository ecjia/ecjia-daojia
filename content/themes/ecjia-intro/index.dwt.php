    ...
    <body>
        ...
        <div class="ecjia-container">
            ...
            <div class="page-footer">
                ...
                <p>{if $company_name}{$company_name} {t domain="ecjia-intro"}版权所有{/t}{/if} {if ecjia::config('icp_number')}&nbsp;&nbsp;<a href="http://beian.miit.gov.cn" target="_blank"> {ecjia::config('icp_number')}</a>{/if}&nbsp;&nbsp;{$commoninfo.powered}</p>
