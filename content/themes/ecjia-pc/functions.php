...
RC_Hook::add_action('merchant/index/comment', array('merchant_controller', 'comment'));//商家评论列表
RC_Hook::add_action('merchant/index/detail', array('merchant_controller', 'detail'));//商家详情

RC_Hook::add_action('merchant/store/category', array('merchant_controller', 'category'));//商家列表

/**
 * 这里开始 注册“方法函数”自动加载列表 到Hook自动加载列表，为自动加载做准备
 */
RC_Hook::add_action('class_pc_function', function () {RC_Loader::load_theme('extras/classes/utility/pc_function.class.php');});
