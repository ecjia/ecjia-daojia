...
class DemoStoreFranchiseeTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $data = array(
            array(
                ...
                'manage_mode'               => 'self',
                'merchants_name'            => '天天果园',
                'shop_keyword'              => '水果，进口水果，时令，国产',
                'status'                    => 1,
                'shop_close'                => 0,
                'responsible_person'        => '张三',
                'company_name'              => '',
                'email'                     => 'xxx@ecmoban.com',
        ...
        RC_DB::table('store_franchisee')->truncate();
