...
class Version_10401 extends Version
{
     ...
     * 移除1.4.0版本中insert的数据库脚本
     */
    protected function updateMigrationsData()
    {
    ...
    protected function fixAddonGroupId()
    {
        $codes = [
            ...
            'addon_active_plugins',
            'addon_system_plugins',
            'addon_widget_nav_menu',
            'addon_widget_cat_articles',
            'addon_widget_cat_goods',
            'addon_widget_brand_goods',
            'addon_widget_ad_position',
            'addon_user_integrate_plugins',
            'addon_mobile_payment_plugins',
            'addon_shipping_plugins',
            'addon_cycleimage_plugins',
            'addon_captcha_plugins',
            'addon_platform_plugins',
            'addon_merchant_plugins',
            'addon_cron_plugins',
