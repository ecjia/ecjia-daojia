...
class Version_11500 extends Version
{
     ...
     * 升级时老数据修复
     */
    public function fixStoreAccount()
    {
        $store_account_table = RC_DB::getTableFullName('store_account');
        $store_franchisee_table = RC_DB::getTableFullName('store_franchisee');
        $sql = "INSERT INTO $store_account_table (`store_id`) SELECT store_id FROM $store_franchisee_table;";
        RC_DB::statement($sql);
    }
    ...
    {
        return __DIR__ . '/ecjia-daojia-patch-v1.15.0.log';
    }
