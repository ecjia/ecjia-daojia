...
class CreateAdminUserTable extends Migration {
	...
	public function up()
	{
		RC_Schema::create('admin_user', function(Blueprint $table)
		{
            ...
            $table->string('user_name', 60)->index('user_name');
            ...
            $table->string('lang_type', 50)->nullable();
            $table->mediumInteger('agency_id')->unsigned()->default('0')->index('agency_id');
            $table->mediumInteger('suppliers_id')->unsigned()->default('0');
