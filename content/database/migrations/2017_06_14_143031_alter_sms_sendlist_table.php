...
class AlterSmsSendlistTable extends Migration {
	...
	public function up()
	{
	    ...
	    {
	        $table->renameColumn('pri', 'priority')->comment('0 延迟发送，1 优先发送');
	    });
	    
	    RC_Schema::table('sms_sendlist', function(Blueprint $table)
	    {
	        $table->text('sms_content')->nullable()->comment('适合发短信内容的厂商')->change();
	        $table->string('template_id', 30)->nullable()->comment('对应厂商的模板ID')->change();
	    });
	    
		RC_Schema::table('sms_sendlist', function(Blueprint $table)
		{
		    $table->text('sms_params')->nullable()->comment('模板内的变量参数，序列化存储')->after('sms_content');
	...
	public function down()
	{
	    RC_Schema::table('sms_sendlist', function(Blueprint $table)
	    {
	        $table->renameColumn('priority', 'pri');
	    });
	    
	    RC_Schema::table('sms_sendlist', function(Blueprint $table)
	    {
	        $table->text('sms_content')->nullable()->change();
	        $table->mediumInteger('template_id')->unsigned()->default('0')->change();
	    });
