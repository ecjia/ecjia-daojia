...
class CreateBonusTypeTable extends Migration {
	...
	public function up()
	{
		RC_Schema::create('bonus_type', function(Blueprint $table)
		{
            ...
            $table->decimal('type_money', 10, 2)->unsigned()->default('0.00');
            $table->tinyInteger('send_type')->unsigned()->default('0');
            $table->tinyInteger('usebonus_type')->unsigned()->default('0');
            $table->decimal('min_amount', 10, 2)->unsigned()->default('0.00');
            $table->decimal('max_amount', 10, 2)->unsigned()->default('0.00');
            $table->integer('send_start_date')->unsigned()->default('0');
            $table->integer('send_end_date')->unsigned()->default('0');
            $table->integer('use_start_date')->unsigned()->default('0');
            $table->integer('use_end_date')->unsigned()->default('0');
