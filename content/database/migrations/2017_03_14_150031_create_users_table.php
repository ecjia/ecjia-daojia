...
class CreateUsersTable extends Migration {
	...
	public function up()
	{
		RC_Schema::create('users', function(Blueprint $table)
		{
		    ...
		    $table->string('user_name', 60)->unique('user_name');
		    ...
		    $table->decimal('credit_line', 10, 2)->unsigned()->default('0.00');
		    $table->string('passwd_question', 50)->nullable();
		    $table->string('passwd_answer', 255)->nullable();
		});
	}
