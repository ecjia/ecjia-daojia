...
class CreateCartTable extends Migration {
	...
	public function up()
	{
		RC_Schema::create('cart', function(Blueprint $table)
		{
            ...
            $table->string('session_id', 40)->nullable()->index('session_id');
            $table->mediumInteger('goods_id');
            $table->string('goods_sn', 60);
            $table->string('product_id', 60)->nullable();
            $table->string('group_id', 60)->nullable();
            ...
            $table->tinyInteger('can_handsel')->unsigned()->default('0');
            $table->tinyInteger('model_attr')->unsigned()->default('0');
            $table->string('goods_attr_id', 60)->nullable();
            $table->decimal('shopping_fee', 10, 2)->unsigned()->default('0.00');
            $table->tinyInteger('is_checked')->unsigned()->default('1')->comment('选中状态，0未选中，1选中');
