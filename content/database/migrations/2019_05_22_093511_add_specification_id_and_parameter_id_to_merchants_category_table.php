...
class AddSpecificationIdAndParameterIdToMerchantsCategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        RC_Schema::table('merchants_category', function (Blueprint $table) {
            $table->integer('specification_id')->unsigned()->default('0')->comment('绑定规格模板')->after('is_show');
