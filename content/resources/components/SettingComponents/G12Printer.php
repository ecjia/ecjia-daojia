...
class G12Printer extends ComponentAbstract
{
    ...
    public function handle()
    {
        $config = [
            ...
            [
                'cfg_code' => 'printer_display_platform',
                'cfg_name' => '',
                'cfg_desc' => '',
                'cfg_range' => [0,1],
                'cfg_value' => '0',
