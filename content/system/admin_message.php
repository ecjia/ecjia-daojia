...
//        $this->db_view = RC_Loader::load_model('admin_message_user_viewmodel');
    ...
    public function init()
    {
        ...
        $chat_id = (int)$this->request->input('chat_id');
        ...
        $admin_list = $admin_list->map(function ($model) use ($admin_online, $chat_id, &$admin_online_sort, &$admin_id_sort) {
            ...
            $admin_online_sort[] = $model->is_online;
            $admin_id_sort[] = $model->user_id;
            $model->user_id == $chat_id && $this->assign('chat_name', $model->user_name);
            return $model;
        })->toArray();
