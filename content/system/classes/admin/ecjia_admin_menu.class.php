...
class ecjia_admin_menu extends Object {
    ...
    public final function admin_menu() {
        ...
        ecjia_admin::$controller->assign('menus', $new_menus);
    ...
    public function clean_admin_menu_cache() {
        RC_Cache::app_cache_delete($this->cache_key, 'system');
    }
    ...
    {
        $cache_menus = RC_Cache::app_cache_get($this->cache_key, 'system');
        ...
        $menus[self::kSYSTEM]    = $this->_request_admin_menu(array('system'), 'system_menu');
