...
class Site
{
    ...
    public function __construct($code)
    {
        ...
        $this->code = $code;
        $this->name = RC_Config::get('site.site_name', $code);
        $this->folder = RC_Config::get('site.site_folder', $code);
        
        $this->shopType = RC_Config::get('site.shop_type');
        $this->mainApp = RC_Config::get('site.main_app');
        $this->useSubDomain = RC_Config::get('site.use_sub_domain');
        $this->webPath = RC_Config::get('site.web_path');
