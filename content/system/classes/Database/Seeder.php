...
class Seeder
{
     ...
     * The seeder instance.
     *
     * @var \Royalcms\Component\Database\Seeder
     */
    protected $seeder;
    ...
    {
        $this->resolver->setDefaultConnection($this->database);
    ...
    {
        $class = royalcms()->make($this->class);
    
        return $class->setContainer(royalcms());
    }
