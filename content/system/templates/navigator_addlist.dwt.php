...
<div id="navigator_addlist">
	<div class="row-fluid">
		<form action="{$form_action}" method="get" name="theForm">
			<div class="nav_list choose_list span12">
				...
				<span class="m_r5">{t}或{/t}</span><a class="data-pjax" href="{url path='@navigator/init'}">{t}返回自定义导航栏{/t}</a>
			</div>
		</form>
	</div>
	<div class="row-fluid nav_main">
		...
		<div class="span9 nav_edit">
			<form class="add_navlist_form" name="theForm" action="{url path='@navigator/update_nav_list'}" method="post">
