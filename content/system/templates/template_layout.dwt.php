        ...
        <div class="ms-selectable">
            <div class="template_list" id="ms-custom-navigation">
                ...
                <ul class="unstyled">
                    ...
                    <li class="ms-elem-selectable"><a class="data-pjax{if $key eq $template_file} choose{/if}" href="{url path='admincp/admin_layout/init' args=$url_args}">{$val.File} <br /> {$val.Name}</a></li>
                    <!-- {/foreach} -->
                </ul>
            </div>
        </div>
