...
;(function(ecjia) {
    ...
    function EcjiaHooks() {
        ...
        EcjiaHooks.prototype.add_action = createAddHook( this._hooks.actions );
        EcjiaHooks.prototype.add_filter = createAddHook( this._hooks.filters );

        // Remove action/filter functions.
        EcjiaHooks.prototype.remove_action = createRemoveHook( this._hooks.actions );
        EcjiaHooks.prototype.remove_filter = createRemoveHook( this._hooks.filters );

        // Has action/filter functions.
        EcjiaHooks.prototype.has_action = createHasHook( this._hooks.actions );
        EcjiaHooks.prototype.has_filter = createHasHook( this._hooks.filters );

        // Remove all actions/filters functions.
        EcjiaHooks.prototype.remove_all_actions = createRemoveHook( this._hooks.actions, true );
        EcjiaHooks.prototype.remove_all_filters = createRemoveHook( this._hooks.filters, true );

        // Do action/apply filters functions.
        EcjiaHooks.prototype.do_action     = createRunHook( this._hooks.actions );
        EcjiaHooks.prototype.apply_filters = createRunHook( this._hooks.filters, true );

        // Current action/filter functions.
        EcjiaHooks.prototype.current_action = createCurrentHook( this._hooks.actions );
        EcjiaHooks.prototype.current_filter = createCurrentHook( this._hooks.filters );

        // Doing action/filter: true while a hook is being run.
        EcjiaHooks.prototype.doing_action = createDoingHook( this._hooks.actions );
        EcjiaHooks.prototype.doing_filter = createDoingHook( this._hooks.filters );

        // Did action/filter functions.
        EcjiaHooks.prototype.did_action = createDidHook( this._hooks.actions );
        EcjiaHooks.prototype.did_filter = createDidHook( this._hooks.filters );
    }
