      ...
      , methods = {
        init: function (opt) {
          this.each(function () {
              ...
              $spanLeft = $('<span></span>').addClass("labelLeft").text(options.label.enabled === undefined ? $(this).children().attr("data-on") === undefined ? 'ON' : $(this).children().attr("data-on") : options.label.enabled);
              $spanRight = $('<span></span>').addClass("labelRight").text(options.label.disabled === undefined ? $(this).children().attr("data-off") === undefined ? 'OFF' : $(this).children().attr("data-off") : options.label.disabled);
              ...
              $element.find('input:checkbox').on('change', function (e, skipOnChange) {
                ...
                if (!skipOnChange) options.onChange($element, active, e);
                
                $(this).parent().parent().children("input[type='hidden']").removeAttr("name");
                if(!$(this).parent().children("input[type='checkbox']").is(":checked")) {
            		$(this).parent().parent().children("input[type='hidden']").attr("name",$(this).parent().children("input[type='checkbox']").attr('name'));
            	}
              });
