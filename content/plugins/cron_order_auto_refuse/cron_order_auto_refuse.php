...
RC_Plugin::register_activation_hook(__FILE__, array('plugin_cron_order_auto_refuse', 'install'));
RC_Plugin::register_deactivation_hook(__FILE__, array('plugin_cron_order_auto_refuse', 'uninstall'));
