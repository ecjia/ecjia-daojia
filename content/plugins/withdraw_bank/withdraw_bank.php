...
RC_Plugin::register_activation_hook(__FILE__, array('plugin_withdraw_bank', 'install'));
RC_Plugin::register_deactivation_hook(__FILE__, array('plugin_withdraw_bank', 'uninstall'));
