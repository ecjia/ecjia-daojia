...
use Ecjia\App\Withdraw\WithdrawAbstract;

class withdraw_bank extends WithdrawAbstract
{
    /**
     * 获取插件代号
     *
    ...
    {
        return $this->loadConfig('withdraw_code');
    }
     ...
     * 转账操作方法
     * @param $order_sn
     * @return \Royalcms\Component\Support\Collection | ecjia_error | bool
     */
