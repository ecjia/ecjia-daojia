...
Plugin URI: http://www.ecjia.com/plugins/ecjia.cron_group_buy_succeed/
Description: 计划任务-团购活动成功自动发送短信
Author: ECJIA TEAM
Version: 1.30.0
Author URI: http://www.ecjia.com/
Plugin App: cron
Text Domain: cron_group_buy_succeed
*/
defined('IN_ECJIA') or exit('No permission resources.');
class plugin_cron_group_buy_succeed {
...
RC_Plugin::register_deactivation_hook(__FILE__, array('plugin_cron_group_buy_succeed', 'uninstall'));
