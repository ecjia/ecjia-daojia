...
?>
{if $new_goods}
<div class="ecjia-mod ecjia-new-model ecjia-margin-t {if !$data && !$best_goods}ecjia-mod-pb35{/if}">
	<div class="head-title ecjia-new-goods">
		<h2><i class="icon-new"></i>新品首发<a href="{$more_news}" class="more_info">更多</a></h2>
	</div>
