...
<div class="ecjia-modal">
	...
	<div class="modal-buttons modal-buttons-2 modal-buttons-vertical">
		...
		<a href="{RC_Uri::url('touch/location/select_location')}{if $referer_url}&referer_url={$referer_url}{/if}"><span class="modal-button"><span class="edit_address">更换地址</span></span></a>
	</div>
</div>
