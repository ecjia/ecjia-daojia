...
<div class="ecjia-modal">
	...
	<div class="modal-buttons modal-buttons-2 modal-buttons-vertical">
		<a href="{RC_Uri::url('user/address/add_address')}&clear=1{if $smarty.cookies.location_address}&address={$smarty.cookies.location_address}{/if}{if $referer_url}&referer_url={$referer_url}{/if}"><span class="modal-button" style="border-radius: 0;"><span class="create_address">新建收货地址</span></span></a>
