	...
	<div class="ecjia-checkout ecjia-margin-b">
		<div class="flow-goods-list">
			...
			<div class="order-ft-link">
				...
				{if $order.pay_status eq 0 && $order.order_status lt 2}<a class="btn btn-small btn-hollow cancel_order" href='{url path="user/order/order_cancel" args="order_id={$order.order_id}"}'>取消订单</a> <a class="btn btn-small btn-hollow" href='{url path="payment/pay/init" args="order_id={$order.order_id}"}'>去支付</a>{/if}
