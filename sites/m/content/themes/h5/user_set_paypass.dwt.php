...
<form class="ecjia-user ecjia-form ecjia-user-no-border-b" name="payPassForm" action="{url path='user/profile/check_pay_pass'}" method="post">
	<div class="ecjia-form ecjia-login">
		<p class="ecjiaf-tac ecjia-margin-b">{if !$type}{t domain="h5"}设置6位数字支付密码{/t}{else if $type eq 'confirm'}{t domain="h5"}再次确认六位数字支付密码{/t}{/if}</p>
		...
		<p class="ecjiaf-tac">{t domain="h5"}为提供更好的支付体验，请设置由6位数字组合的支付密码{/t}</p>
