...
RC_Hook::add_action('ecjia_front_finish_launching', function () {
    ...
    $common_url = array(
        'home_url'                 => ecjia_member_uri::home_url(),
        'login_url'                => ecjia_member_uri::login_url(),
        'register_url'             => ecjia_member_uri::register_url(),
        'user_order_url'           => ecjia_member_uri::user_order_url(),
        'user_order_await_pay_url' => ecjia_member_uri::user_order_await_pay_url(),
        'user_order_shipped_url'   => ecjia_member_uri::user_order_shipped_url(),
        'user_bonus_url'           => ecjia_member_uri::user_bonus_url(),
        'user_account_url'         => ecjia_member_uri::user_account_url(),
        'user_address_url'         => ecjia_member_uri::user_address_url(),
        'user_spread_url'          => ecjia_member_uri::user_spread_url(),
