...
class CreateWechatCustomMessageTable extends Migration {
	...
	public function up()
	{
		...
		RC_Schema::create('wechat_custom_message', function(Blueprint $table)
		{
		    $table->increments('id')->comment('自增 ID 号');
		    $table->integer('uid')->unsigned()->default('0')->comment('用户id');
		    $table->string('msg', 255)->nullable()->comment('信息内容');
		    $table->smallInteger('iswechat')->unsigned()->nullable()->comment('0用户信息，1公众号信息');
	...
	{
		RC_Schema::drop('wechat_custom_message');
	}
