...
class AddColumnUserTypeToConnectUserTable extends Migration {
	...
	public function up()
	{
		...
		{
            if (!RC_Schema::hasColumn('connect_user', 'user_type')) $table->string('user_type', 30)->default('user')->after('user_id');
		});
