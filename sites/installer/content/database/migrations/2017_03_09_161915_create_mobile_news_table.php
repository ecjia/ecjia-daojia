...
class CreateMobileNewsTable extends Migration {
	...
	public function up()
	{
        if (RC_Schema::hasTable('mobile_news')) {
            return ;
        }

		RC_Schema::create('mobile_news', function(Blueprint $table)
		{
		    ...
		    $table->char('type', 10)->nullable()->comment('article或goods');
		    $table->tinyInteger('status')->default('0')->comment('发布状态，0为未发布，1为发布');
