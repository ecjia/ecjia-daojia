...
class DropIndexOrderIdToExpressOrderTable extends Migration {
	...
	public function up()
	{
		...
		{
            if ($table->hasIndex('order_id')) $table->dropIndex('order_id');
	...
	public function down()
	{
		...
		RC_Schema::table('express_order', function(Blueprint $table)
		{
            if (!$table->hasIndex('order_id')) $table->index('order_id', 'order_id');
