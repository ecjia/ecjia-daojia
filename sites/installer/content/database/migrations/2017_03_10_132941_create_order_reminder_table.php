...
class CreateOrderReminderTable extends Migration {
	...
	public function up()
	{
        if (RC_Schema::hasTable('order_reminder')) {
            return ;
        }

		RC_Schema::create('order_reminder', function(Blueprint $table)
		{
		    ...
		    $table->string('status', 100)->nullable()->comment('状态');
