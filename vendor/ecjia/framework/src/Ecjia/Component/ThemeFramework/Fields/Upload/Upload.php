...
class Upload extends Options
{
    ...
    public function output()
    {
        ...
        $button_title = ( isset( $button_title ) ) ? $button_title : __( 'Upload', 'ecjia' );
        $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : __( 'Upload', 'ecjia' );
        $insert_title = ( isset( $insert_title ) ) ? $insert_title : __( 'Use Image', 'ecjia' );
