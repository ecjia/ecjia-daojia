...
class AdminLogAction
{
    ...
    public function __construct()
    {
        $this->items = [
            ...
            'remove'            => __('删除', 'ecjia'),
            'install'           => __('安装', 'ecjia'),
            'uninstall'         => __('卸载', 'ecjia'),
            'setup'             => __('设置', 'ecjia'),
            'trash'             => __('回收', 'ecjia'),
            'restore'           => __('还原', 'ecjia'),
            'merge'             => __('合并', 'ecjia'),
            'batch_remove'      => __('批量删除', 'ecjia'),
            'batch_trash'       => __('批量回收', 'ecjia'),
            'batch_restore'     => __('批量还原', 'ecjia'),
            'batch_upload'      => __('批量上传', 'ecjia'),
            'batch_edit'        => __('批量编辑', 'ecjia'),
            'batch_stop'        => __('批量停用', 'ecjia'),
        ];
    }
