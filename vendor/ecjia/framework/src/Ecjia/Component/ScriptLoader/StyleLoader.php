...
use Ecjia\Component\ScriptLoader\Contracts\StyleLoaderInterface;
use RC_Uri;
use RC_Hook;
 ...
 * @package ecjia
 */
class StyleLoader extends AbstractLoader implements StyleLoaderInterface
{

    protected $concatenate_styles;
    protected $compress_css;

    public function __construct(HandleStyles $styles)
    {
    ...
    protected function default_styles()
    {
        ...
        // default style add ...
        RC_Hook::do_action('ecjia_style_default_loader', $this);
    }
    ...
    public function print_head_styles()
    {
        ...
        $this->handler->do_concat = $this->concatenate_styles;
        $this->handler->do_items(false);
    ...
    protected function _print_styles()
    {
        ...
        if ( $concat = trim( $this->handler->concat, ', ' ) ) {
            ...
            $dir = $this->handler->text_direction;
            $ver = $this->handler->default_version;
