...
abstract class Editor
{
    ...
    public function set_quality($quality = null)
    {
         ...
         *            Image mime type.
         */
        $quality = RC_Hook::apply_filters('image_editor_set_quality', $quality, $this->mime_type);
        ...
        if ('image/jpeg' == $this->mime_type) {
             ...
             */
            $quality = RC_Hook::apply_filters('jpeg_quality', $quality, 'image_resize');
    ...
    protected function get_output_format($filename = null, $mime_type = null)
    {
        ...
        if (! $this->supports_mime_type($mime_type)) {
             ...
             *            Mime type string.
             */
            $mime_type = RC_Hook::apply_filters('image_editor_default_mime_type', $this->default_mime_type);
            $new_ext = $this->get_extension($mime_type);
        }
        ...
        if ($filename) {
            ...
            $filename = RC_Format::trailingslashit($dir) . wp_basename($filename, ".$ext") . ".{$new_ext}";
        }
    ...
    public function generate_filename($suffix = null, $dest_path = null, $extension = null)
    {
        ...
        return RC_Format::trailingslashit($dir) . "{$name}-{$suffix}.{$new_ext}";
    }
