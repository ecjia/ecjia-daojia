...
/**
 * RoyalCMS Scripts enqueue.
 *
 * These classes were refactored from the RoyalCMS RC_Scripts and RoyalCMS
 * script enqueue API.
 *
 * @package RoyalCMS
 * @since r16
...
/**
 * RoyalCMS Scripts enqueue class.
 *
 * @package RoyalCMS
 * @uses RC_Dependencies
 * @since r16
 */
class HandleScripts extends Dependencies
{
    ...
    function init()
    {
         ...
         *       
         * @param
         *            WP_Scripts &$this WP_Scripts instance, passed by reference.
         */
        \RC_Hook::do_action_ref_array('rc_default_scripts', array(
            &$this
        ));
    }
     ...
     *
     * @param mixed $handles
     *            (optional) Scripts to be printed. (void) prints queue, (string) prints that script, (array of strings) prints those scripts.
     * @param int $group
    ...
    function do_item($handle, $group = false)
    {
         ...
         */
            // $src = RC_Format::esc_url( RC_Hook::apply_filters( 'script_loader_src', $src, $handle ) );
