...
class HandleStyles extends Dependencies
{
    ...
    {
        /**
         * Fires when the HandleStyles instance is initialized.
         *
         * @since 2.6.0
         *       
         * @param HandleStyles &$this HandleStyles instance, passed by reference.
         */
        RC_Hook::do_action_ref_array('rc_default_styles', array(
            &$this
        ));
    }
