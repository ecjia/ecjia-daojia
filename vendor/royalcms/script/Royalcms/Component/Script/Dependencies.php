 ...
 *
 * Classes were refactored from the RC_Scripts and RoyalCMS script enqueue API.
 *
 * @since driver
 *
 * @package driver
...
class Dependencies
{
    ...
    public function do_items($handles = false, $group = false)
    {
        ...
        foreach ($this->to_do as $key => $handle) {
            if (! in_array($handle, $this->done, true) && isset($this->registered[$handle])) {
                 ...
                 * but no source.
                 * Queuing the item queues the dependencies.
                 *
     ...
     *            The item url.
     * @param array $deps
     *            Optional. An array of item handle strings on which this item depends.
     * @param string $ver
     *            Optional. Version (used for cache busting).
     * @param mixed $args
