...
use Royalcms\Component\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Royalcms\Component\Validation\PresenceVerifierInterface
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\Royalcms\Component\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\Royalcms\Component\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \Royalcms\Component\Validation\PresenceVerifierInterface
     *
