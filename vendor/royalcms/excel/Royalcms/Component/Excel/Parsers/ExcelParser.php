...
use Royalcms\Component\Excel\Collections\RowCollection;
use Royalcms\Component\Excel\Collections\CellCollection;
use Royalcms\Component\Excel\Collections\SheetCollection;

/**
 *
 * Royalcms Excel Excel Parser
 *
 */
class ExcelParser {
     ...
     * @return \Royalcms\Component\Excel\Parsers\ExcelParser
     */
    ...
    {
        // If has a date
        if ( ($cellContent = $this->cell->getCalculatedValue()) !== false )
        {
