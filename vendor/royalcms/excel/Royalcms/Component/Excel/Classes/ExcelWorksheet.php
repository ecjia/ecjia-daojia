<?php namespace Royalcms\Component\Excel\Classes;
...
use Royalcms\Component\Excel\Writers\CellWriter;
use Royalcms\Component\Excel\Exceptions\ExcelException;
use PHPExcel_Worksheet_PageSetup;

/**
 *
 * Royalcms Excel wrapper for PHPExcel_Worksheet
 *
 */
class ExcelWorksheet extends PHPExcel_Worksheet {
    ...
    {
        return $this->parser = $parser ? $parser : royalcms('excel.parsers.view');
    }
    ...
    public function _setAttributes($setter, $params)
    {
        ...
        {
            throw new ExcelException('[ERROR] Royalcms Worksheet method [' . $setter . '] does not exist.');
        }
    }
    ...
    public function __call($method, $params)
    {
        ...
        throw new ExcelException('[ERROR] Royalcms Worksheet method [' . $method . '] does not exist.');
    }
