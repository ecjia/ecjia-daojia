...
use Royalcms\Component\Excel\Parsers\ExcelParser;
...
class ExcelReader {
    ...
    protected function initNewWriterWhenNeeded()
    {
        if(!$this->writer)
        {
            $this->writer = royalcms('excel.writer');
    ...
    public function __call($method, $params)
    {
        ...
        throw new ExcelException('[ERROR] Reader method [' . $method . '] does not exist.');
    }
