 ...
 * Royalcms Error API.
 *
 * Contains the RC_Error class and the is_error() function.
 *
 * @package Royalcms
 */
 ...
 *
 * Container for checking for Royalcms errors and error messages. Return
 * RC_Error and use {@link is_error()} to check if this class is returned.
 * Many core Royalcms functions pass this class in the event of an error and
