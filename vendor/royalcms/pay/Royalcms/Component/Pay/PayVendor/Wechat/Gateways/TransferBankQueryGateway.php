...
use \Royalcms\Component\Pay\PayVendor\Wechat\Orders\TransfersBankQueryOrder;

class TransferBankQueryGateway extends Gateway
{
    /**
     * Pay an order.
     *
     * @param string $endpoint
     * @param \Royalcms\Component\Pay\PayVendor\Wechat\Orders\TransfersBankQueryOrder $payload
     *
    ...
    {
        if (! ($payload instanceof TransfersBankQueryOrder)) {
            throw new GatewayException('The payload must is "\Royalcms\Component\Pay\PayVendor\Wechat\Orders\TransfersBankQueryOrder" instance!');
        }
