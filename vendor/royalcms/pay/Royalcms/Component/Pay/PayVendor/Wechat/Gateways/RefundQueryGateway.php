...
use Royalcms\Component\Pay\PayVendor\Wechat\Orders\RefundQueryOrder;

class RefundQueryGateway extends Gateway
{
    /**
     * Pay an order.
     *
     * @param string $endpoint
     * @param \Royalcms\Component\Pay\PayVendor\Wechat\Orders\RefundQueryOrder $payload
     *
    ...
    {
        if (! ($payload instanceof RefundQueryOrder)) {
            throw new GatewayException('The payload must is "\Royalcms\Component\Pay\PayVendor\Wechat\Orders\RefundQueryOrder" instance!');
        }
