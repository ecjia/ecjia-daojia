...
class EllipseCommand extends \Royalcms\Component\Image\Commands\AbstractCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        $ellipse_classname = sprintf('\Royalcms\Component\Image\%s\Shapes\EllipseShape',
