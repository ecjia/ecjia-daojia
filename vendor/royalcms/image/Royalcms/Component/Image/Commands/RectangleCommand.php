...
class RectangleCommand extends \Royalcms\Component\Image\Commands\AbstractCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        $rectangle_classname = sprintf('\Royalcms\Component\Image\%s\Shapes\RectangleShape',
