...
abstract class AbstractDecoder
{
    ...
    public function initFromUrl($url)
    {
        ...
        throw new \Royalcms\Component\Image\Exception\NotReadableException(
    ...
    /**
     * Determines if current source data is Royalcms\Component\Image\Image object
     *
     * @return boolean
     */
    public function isRoyalcmsImage()
    {
        return is_a($this->data, '\Royalcms\Component\Image\Image');
    }
    ...
    /**
     * Initiates new Image from Royalcms\Component\Image\Image
     *
     * @param  Image $object
     * @return \Royalcms\Component\Image\Image
     */
    public function initFromRoyalcmsImage($object)
    {
        return $object;
    }
    ...
    public function init($data)
    {
        ...
        switch (true) {
            ...
            case $this->isRoyalcmsImage():
                return $this->initFromRoyalcmsImage($this->data);
