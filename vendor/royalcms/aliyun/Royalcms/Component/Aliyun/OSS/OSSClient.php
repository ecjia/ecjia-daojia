...
use Royalcms\Component\Aliyun\Common\Communication\ServiceClientFactory;
use Royalcms\Component\Aliyun\OSS\Commands\GeneratePresignedUrlCommand;
...
class OSSClient {
    ...
    /**
     * @var \Royalcms\Component\Aliyun\Common\Communication\ServiceClientInterface
     */
    ...
    protected function execute($method, $options) {
        ...
        $class = 'Royalcms\\Component\\Aliyun\\OSS\\Commands\\'.$className;
