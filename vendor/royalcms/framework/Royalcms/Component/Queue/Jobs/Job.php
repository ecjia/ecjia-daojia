...
abstract class Job
{
     ...
     *
     * @param  mixed  $value
     * @return \Royalcms\Component\Contracts\Queue\QueueableEntity
     */
     ...
     *
     * @return \Royalcms\Component\Contracts\Queue\EntityResolver
     */
    protected function getEntityResolver()
    {
        return $this->container->make('Royalcms\Component\Contracts\Queue\EntityResolver');
    }
