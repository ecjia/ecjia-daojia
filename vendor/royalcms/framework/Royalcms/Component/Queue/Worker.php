...
class Worker {
	 ...
	 *
	 * @param  \Royalcms\Component\Queue\Queue  $connection
	 * @param  string  $queue
	 * @return \Royalcms\Component\Queue\Jobs\Job|null
	 */
	...
	protected function raiseFailedJobEvent($connection, Job $job)
	{
		if ($this->events)
		{
			...
			$this->events->fire('royalcms.queue.failed', array($connection, $job, $data));
		}
	}
