...
class Translator extends NamespacedItemResolver implements TranslatorInterface
{
     ...
     *
     * @var \Royalcms\Component\Translation\LoaderInterface
     */
    protected $loader;
     ...
     *
     * @param  \Royalcms\Component\Translation\LoaderInterface  $loader
     * @param  string  $locale
     * @return void
     */
     ...
     *
     * @return \Royalcms\Component\Translation\LoaderInterface
     */
    ...
    /**
     * Get all of the translation items for the application.
     *
     * @return array
     */
    public function all()
