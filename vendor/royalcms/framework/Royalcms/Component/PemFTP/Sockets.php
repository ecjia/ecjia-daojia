 ...
 * @license LGPL http://www.opensource.org/licenses/lgpl-license.html
 */
class Component_PemFTP_Socket extends Component_PemFTP_Base
{
    ...
    {
        if (! @socket_set_option($sock, SOL_SOCKET, SO_RCVTIMEO, array(
            "sec" => $this->_timeout,
            "usec" => 0
        ))) {
        ...
        if (! @socket_set_option($sock, SOL_SOCKET, SO_SNDTIMEO, array(
            "sec" => $this->_timeout,
            "usec" => 0
        ))) {
