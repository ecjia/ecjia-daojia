<?php namespace Royalcms\Component\Session\Middleware;
...
class Middleware implements HttpKernelInterface {
	 ...
	 * @return void
	 */
	public function __construct(HttpKernelInterface $royalcms, SessionManager $manager, Closure $reject = null)
	{
