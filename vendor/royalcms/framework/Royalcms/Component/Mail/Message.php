...
class Message {
	...
	{
	    $this->swift->setBody($body, $contentType, $charset);
	 ...
	 * @return \Royalcms\Component\Mail\Message
	 */
	public function part($part, $contentType = null, $charset = null)
	{
	    $this->swift->addPart($part, $contentType, $charset);
