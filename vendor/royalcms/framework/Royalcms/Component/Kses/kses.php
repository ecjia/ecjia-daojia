...
if (! defined('KSES_CLASS_PHP5')) {
    ...
    class Component_Kses_Kses
    {
         ...
         * @access public
         * @param string $string
         *            String to be stripped of 'evil scripts'
         ...
         * @access public
         * @param
         *            mixed , A string or array of protocols that will be added to the internal list of allowed protocols.
         ...
         *            The name of the protocol to be added.
         ...
         * @access public
         * @param string $protocol
         *            The name of the protocol to be removed.
         ...
         * @access public
         * @param
         *            mixed , A string or array of protocols that will be removed from the internal list of allowed protocols.
         ...
         * @access public
         * @param
         *            mixed , A string or array of protocols that will be the new internal list of allowed protocols.
         ...
         * @access public
         * @param string $tag
         *            (X)HTML tag that will be allowed after stripping text.
         * @param array $attribs
         ...
         * @access public
         * @param string $string
         *            String to perfrom additional modifications on.
         ...
         *            (X)HTML tag to check
         * @param string $attr
         *            Text containing attributes to check for validity.
         ...
         * @access private
         * @param string $attr
         *            Text containing tag attributes for parsing
         ...
         * @param string $vless
         *            Indicates whether the the value is supposed to be valueless
         * @param string $checkname
         *            The check to be performed
         * @param string $checkvalue
         *            The value that is to be checked against
         ...
         *            This variable is ignored for this test
         * @param string $vless
         *            Flag indicating if this attribute is not supposed to have an attribute
         * @return bool Indicates whether the check passed or not
         * @see checkAttributeValue()
         * @since PHP5 OOP 1.0.0
         */
