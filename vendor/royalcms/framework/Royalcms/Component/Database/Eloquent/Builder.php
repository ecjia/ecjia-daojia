...
class Builder
{
     ...
     *
     * @var \Royalcms\Component\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @param  \Royalcms\Component\Database\Eloquent\Builder  $hasQuery
     * @param  \Royalcms\Component\Database\Eloquent\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
