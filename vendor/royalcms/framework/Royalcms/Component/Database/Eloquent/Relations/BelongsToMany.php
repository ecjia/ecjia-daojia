...
class BelongsToMany extends Relation {
	...
	{
		$query->select(new \Royalcms\Component\Database\Query\Expression('count(*)'));
		...
		return $query->where($hash.'.'.$this->foreignKey, '=', new \Royalcms\Component\Database\Query\Expression($key));
	}
	 ...
	 *
	 * @param  \Royalcms\Component\Database\Eloquent\Builder|null
	 * @return \Royalcms\Component\Database\Eloquent\Relations\BelongsToMany
	 */
