...
abstract class FilesystemBase
{
    ...
    {
        _deprecated_function(__FUNCTION__, '3.8', '\Royalcms\Component\FilesystemKernel::abspath() or \Royalcms\Component\FilesystemKernel::rc_*_dir()');
        $this->verbose = $echo;
        return $this->abspath();
    }
     ...
     * @access public
     * @since 2.5.0
     * @deprecated 2.7.0 use \Royalcms\Component\FilesystemKernel::abspath() or WP_Filesystem::rc_*_dir() methods instead.
     * @see \Royalcms\Component\FilesystemKernel::abspath()
     * @see \Royalcms\Component\FilesystemKernel::rc_content_dir()
     * @see \Royalcms\Component\FilesystemKernel::rc_plugins_dir()
     * @see \Royalcms\Component\FilesystemKernel::rc_themes_dir()
     * @see \Royalcms\Component\FilesystemKernel::rc_lang_dir()
     *
     * @param string $base
     *            The folder to start searching from.
     * @param bool $echo
