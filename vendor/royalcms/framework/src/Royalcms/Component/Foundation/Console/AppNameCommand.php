...
class AppNameCommand extends Command
{
    ...
    {
        $this->currentRoot = trim($this->royalcms->getNamespace(), '\\');
    ...
    protected function setAppConfigNamespaces()
    {
        ...
        $this->replaceIn($this->getConfigPath('system'), $search, $replace);
    }
    ...
    {
        $this->replaceIn(
            $this->royalcms->databasePath().'/factories/ModelFactory.php', $this->currentRoot, $this->argument('name')
        );
    }
    ...
    {
        return $this->royalcms->basePath().'/bootstrap/app.php';
    }
    ...
    {
        return $this->royalcms->basePath().'/composer.json';
    }
    ...
    {
        return $this->royalcms['path.config'].'/'.$name.'.php';
    }
    ...
    {
        return $this->royalcms->basePath().'/phpspec.yml';
    }
