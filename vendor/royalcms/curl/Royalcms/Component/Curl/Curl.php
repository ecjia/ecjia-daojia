...
namespace Royalcms\Component\Curl;

use Royalcms\Component\Curl\ArrayUtil;
...
class Curl
{
    ...
    private $jsonDecoder = '\Royalcms\Component\Curl\Decoder::decodeJson';
    private $jsonDecoderArgs = array();
    private $jsonPattern = '/^(?:application|text)\/(?:[a-z]+(?:[\.-][0-9a-z]+){0,}[\+\.]|x-)?json(?:-[a-z]+)?/i';
    private $xmlDecoder = '\Royalcms\Component\Curl\Decoder::decodeXml';
    ...
    {
        $this->jsonDecoder = '\Royalcms\Component\Curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\Royalcms\Component\Curl\Decoder::decodeXml';
    }
    ...
    {
        $user_agent = 'royalcms-curl/' . self::VERSION;
