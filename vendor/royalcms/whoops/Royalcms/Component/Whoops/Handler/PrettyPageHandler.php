...
use Royalcms\Component\Whoops\Util\TemplateHelper;
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        $templateFile = $this->getResource("views/layout.html.php");//pretty-template.php
     ...
     *
     * @return \Royalcms\Component\Whoops\Exception\FrameCollection;
     */
    ...
    public function addDataTableCallback($label, /* callable */ $callback)
    {
        ...
        $this->extraTables[$label] = function (\Royalcms\Component\Whoops\Exception\Inspector $inspector = null) use ($callback) {
            try {
