...
class PhpRedisConnection extends Connection
{
     ...
     * @return int
     */
    public function zadd($key, array $dictionary = [])
    {
     ...
     * @return mixed
     */
    public function evalsha($script, $numkeys, array $arguments = [])
    {
        //Insert the element at the beginning of the array
        array_unshift($queue, $this->script('load', $script));
        //Insert the element at the end of the array
        array_push($stack, $numkeys);
