...
use Royalcms\Component\Url\UriGenerate;
...
//        $referer_url = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '';
         ...
         * @param string $orig_scheme Scheme requested for the URL. One of 'http', 'https' or 'relative'.
         */
        return RC_Hook::apply_filters('set_referer_url', $referer_url);
    }
    
//    /**
//     * 站点文件夹名
//     */
//    public static function site_folder($folder = null)
//    {
...
//            $site_folder = $folder;
//        }
//        elseif (RC_Config::get('site.site_folder')) {
...
//                $site_url = self::original_home_url() . rtrim($web_path, '/');
//            }
//            else {
//                if (RC_Config::get('site.use_sub_domain', false)) {
//                    $site_url = self::original_home_url();
//                } else {
//                    $site_url = self::original_home_url() . '/sites/' . $site_folder;
//                }
//            }
//        }
//        else {
...
//    public static function support_schemes()
//    {
...
//    }
    ...
    {
        return UriGenerate::create()->homeUrl($path, $scheme);

//        $orig_scheme = $scheme;
//        $url = self::original_home_url();
//        if (empty($scheme)) {
//            $scheme = self::get_url_scheme($url);
//        }
//
...
//     * @return string
//     */
//    public static function get_url_scheme($url)
//    {
//        if (is_ssl()) {
//            $scheme = 'https';
//        } else {
...
//    }
    ...
    {
        return UriGenerate::create()->setUrlScheme($url, $scheme);

//        $orig_scheme = $scheme;
//        if (! in_array($scheme, self::support_schemes())) {
...
//        return RC_Hook::apply_filters('set_url_scheme', $url, $scheme, $orig_scheme);
    ...
    {
        return UriGenerate::create()->siteUrl($path, $scheme);
...
//        return RC_Hook::apply_filters('site_url', $url, $path, $scheme);
    ...
    {
        return UriGenerate::create()->adminUrl($path, $scheme);
...
//        return RC_Hook::apply_filters('admin_url', $url, $path);
    ...
    {
        return UriGenerate::create()->adminUrl('statics/'.$path, $scheme);
    ...
    {
        return UriGenerate::create()->homeContentUrl($path);
...
//        return RC_Hook::apply_filters('home_content_url', $url, $path);
    ...
    {
        return UriGenerate::create()->contentUrl($path);
...
//        return RC_Hook::apply_filters('content_url', $url, $path);
    ...
    {
        return UriGenerate::create()->vendorUrl($path);
