 ...
 * already a Royalcms\Component\HttpRequest\Cookie() object, then they are turned into one.
 *
...
class Cookie {
	...
	public function getHeaderValue() {
		 ...
		 */
		return $this->name . '=' . RC_Hook::apply_filters( 'rc_http_cookie_value', $this->value, $this->name );
	}
