...
class Streams {
	...
	public function request($url, $args = array()) {
		...
		if ( false === $handle ) {
			...
			if ( $secure_transport && 0 === $connection_error && '' === $connection_error_str )
				return RC_Error::make( 'http_request_failed', __( 'The SSL certificate for the host could not be verified.' ) );

			return RC_Error::make('http_request_failed', $connection_error . ': ' . $connection_error_str );
		}
	...
	public static function test( $args = array() ) {
		 ...
		 */
		return RC_Hook::apply_filters( 'use_streams_transport', true, $args );
	}
}
