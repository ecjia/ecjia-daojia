 ...
 * @since 4.7.0
 */
class Hooks extends RequestsHooks {
	/**
	 * Requested URL.
	 *
	...
	public function dispatch( $hook, $parameters = array() ) {
		...
		switch ( $hook ) {
			case 'curl.before_send':
				...
				RC_Hook::do_action_ref_array( 'http_api_curl', array( &$parameters[0], $this->request, $this->url ) );
				break;
		}
		 ...
		 * @param string $url URL to request.
		 */
		RC_Hook::do_action_ref_array( "requests-{$hook}", $parameters, $this->request, $this->url );
