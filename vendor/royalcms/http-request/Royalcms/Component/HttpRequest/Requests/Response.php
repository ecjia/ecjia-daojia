...
use Royalcms\Component\HttpRequest\Response as HTTPResponse;
use Royalcms\Component\HttpRequest\Cookie;
use Royalcms\Component\HttpRequest\HeaderUtility;
use Royalcms\Component\Requests\Response as RequestsResponse;
use Royalcms\Component\Requests\Response\Headers;
use Royalcms\Component\Requests\Utility\CaseInsensitiveDictionary;
...
class Response extends HTTPResponse {
	 ...
	 */
	public function __construct( RequestsResponse $response, $filename = '' ) {
	...
	public function set_status( $code ) {
		$this->response->status_code = rc_absint( $code );
	}
	...
	public function to_array() {
		return array(
			...
			'response' => array(
				...
				'message' => HeaderUtility::get_status_header_desc( $this->get_status() ),
			),
