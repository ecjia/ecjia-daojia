...
namespace Royalcms\Component\Rememberable\Query;

use DateTime;

class Builder extends \Royalcms\Component\Database\Query\Builder
{
    /**
    ...
    {
        return royalcms('cache')->driver($this->cacheDriver);
    }
