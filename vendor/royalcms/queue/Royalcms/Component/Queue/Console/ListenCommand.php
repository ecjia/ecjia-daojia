...
use Royalcms\Component\Queue\Listener;
...
class ListenCommand extends Command
{
     ...
     *
     * @var \Royalcms\Component\Queue\Listener
     */
    protected $listener;
     ...
     *
     * @param  \Royalcms\Component\Queue\Listener  $listener
     * @return void
     */
    ...
    protected function getQueue($connection)
    {
        if (is_null($connection)) {
            $connection = $this->royalcms['config']['queue.default'];
        }

        $queue = $this->royalcms['config']->get("queue.connections.{$connection}.queue", 'default');
    ...
    {
        $this->listener->setEnvironment($this->royalcms->environment());
