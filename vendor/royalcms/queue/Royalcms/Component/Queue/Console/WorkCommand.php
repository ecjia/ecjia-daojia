...
use Royalcms\Component\Queue\Worker;
...
class WorkCommand extends Command
{
     ...
     *
     * @var \Royalcms\Component\Queue\Worker
     */
    protected $worker;
     ...
     *
     * @param  \Royalcms\Component\Queue\Worker  $worker
     * @return void
     */
    ...
    {
        if ($daemon) {
            $this->worker->setCache($this->royalcms['cache']->driver());

            $this->worker->setDaemonExceptionHandler(
                $this->royalcms['Royalcms\Component\Contracts\Debug\ExceptionHandler']
            );
