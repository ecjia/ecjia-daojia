...
namespace Royalcms\Component\Requests;
...
class Cookie {
	...
	public static function parse($string, $name = '', $reference_time = null) {
		...
		return new Cookie($name, $value, $attributes, array(), $reference_time);
	}
	 ...
	 * @return string
	 */
	public static function parseFromHeaders(Headers $headers) {
