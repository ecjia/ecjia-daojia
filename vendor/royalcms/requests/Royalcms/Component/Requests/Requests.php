...
use Royalcms\Component\Requests\Auth\Basic;
use Royalcms\Component\Requests\Proxy\HTTP;
	...
	public static function add_transport($transport) {
		if (empty(self::$transports)) {
			self::$transports = array(
				'Royalcms\Component\Requests\Transport\cURL',
				'Royalcms\Component\Requests\Transport\fsockopen',
			);
		}
